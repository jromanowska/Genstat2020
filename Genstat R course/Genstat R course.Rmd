...
```{r ex-1-1, exercise = TRUE, exercise.lines = 4}

```

1.2 What is the distribution of the alleles?
```{r ex-1-2, exercise = TRUE, exercise.lines = 4}

```

1.3 Why does it not sum to 100%? Hint: `?table`
```{r ex-1-3, exercise = TRUE, exercise.lines = 4}
...
```{r ex-2-1, exercise = TRUE, exercise.lines = 5}
...
```{r ex-2-2, exercise = TRUE, exercise.lines = 5}
more10.missing <- 
...
```{r ex-3-1, exercise = TRUE, exercise.lines = 5}
```
...
2. Load snpStats package

```{r}
library(snpStats)
```

3. Read ped-file into R
...
```{r ex-5-2, exercise=TRUE, exercise.lines = 5}
```
...
```{r ex-5-3, exercise=TRUE, exercise.lines = 5}
```
...
```{r ex-6-1, exercise=TRUE, exercise.lines = 5}
```
...
```{r ex-7-1, exercise=TRUE, exercise.lines = 5}
```
